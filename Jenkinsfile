        ...
        stage('Push to nexus') {
            steps {
                script {
                    ...
                    sh "mvn deploy:deploy-file -DgroupId=com.turquoise -DartifactId=${PROJECT_NAME} -Dversion=1 -DgeneratePom=false -Dpackaging=tar.gz -DrepositoryId=turquoise-components -Durl=http://146.148.79.21:8081/repository/turquoise-components -Dfile=${TAR_FILENAME} -B"
